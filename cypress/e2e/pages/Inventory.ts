class Inventory {
    ...
    private orderingDropdown: string = ".product_sort_container";    
    ...
    get orderingDropdownElement(): Cypress.Chainable<JQuery<HTMLElement>> {
      return cy.get(this.orderingDropdown);
    }
